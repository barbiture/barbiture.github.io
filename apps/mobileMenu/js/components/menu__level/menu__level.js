...
//         $('.menu__content_slider').slideToggle(options.speed);
//       });
//       $(this).children().css('background', options.color);
//     });
//   },
//   // Define the menuLevel() function that adds the sliding functionality
...
//     return this.each(function(){
//       $(this).addClass('menu__content_slider');
...
// $('#menuToggleLevel').threeBarToggle({color: 'red', width: 30, height: 25});

// // Make any nested ul-based menu mobile
// // Optional arguments are 'speed' and 'accordion' (true or false) to disable the behavior of closing other sub
// $('#menuContentLevel').menuLevel();
var toggle = $('#menuToggleLevel');
toggle.prepend('<i></i><i></i><i></i>');
// toggle.toggle(function() {
//   console.log('msg');
// });
$('#menuContentLevel').hide();
