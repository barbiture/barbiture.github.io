  ...
  for (var i=0; i<objectsList.length; i++) {
    if (objectsList[i].content != this.content){
      ...
      if (this.classOnClick)
        objectsList[i].menuName.removeClass(this.classOnClick);
    }
  }
};
...
;(function(){
  ...
  var cont = document.querySelector('#searchForm .search-form__content');
  var height;
  cont.style.top = cont.offsetHeight;
  HTMLElement.prototype.xtopIn = function(delay) {
    var delay = delay || 0.5;
    this.style.transition = 'all '+delay+'s';
    this.style.top = '0px';
    setTimeout(function() {
  ...
  HTMLElement.prototype.xtopOut = function(delay) {
    var delay = delay || 0.5;
    this.style.transition = 'all '+delay+'s';
  ...
  document.getElementById('searchFormTogle').onclick = function() {
    ...
    if (this.dataset.flag == 'close') {
      this.dataset.flag = 'open';
      cont.xtopIn();
    }else {
      this.dataset.flag = 'close';
      cont.xtopOut();
    };
    document.getElementById('searchFormClose').onclick = function() {
      document.getElementById('searchFormTogle').dataset.flag = 'close';
      cont.xtopOut();
    };
  };
})();
...
;(function(){
  ...
  fastRangeSteps.innerHTML = '<ul class="fast-buy__range__step">'+steps(range.length);+'</ul>'
...
;(function(){
  ...
  var cont = document.querySelector('#fastBuy .fast-buy__content');
  var height;
  cont.style.top = cont.offsetHeight;
  HTMLElement.prototype.topIn = function(delay) {
    var delay = delay || 0.5;
    this.style.transition = 'all '+delay+'s';
    this.style.top = '0px';
    setTimeout(function() {
  ...
  HTMLElement.prototype.topOut = function(delay) {
  ...
  document.getElementById('fastBuyToggle').onclick = function() {
    ...
    document.getElementById('fastBuyClose').onclick = function() {
      document.getElementById('fastBuyToggle').dataset.flag = 'close';
      cont.topOut();
    };
  };
})();
